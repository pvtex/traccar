...
public class WatchProtocolEncoder extends StringProtocolEncoder implements StringProtocolEncoder.ValueFormatter {
    ...
    protected Object encodeCommand(Channel channel, Command command) {
        ...
        return switch (command.getType()) {
            ...
            case Command.TYPE_STATUS_LED -> formatTextCommand(channel, command, "LEDSET,%s", Command.KEY_ENABLE);
            case Command.TYPE_TK_WORKMODE -> formatTextCommand(channel, command, "WORK,%s", Command.KEY_WORKMODE);
            default -> null;
        };
    }
